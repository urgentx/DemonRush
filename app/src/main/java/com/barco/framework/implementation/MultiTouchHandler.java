...
import com.barco.framework.Pool;
import com.barco.framework.Pool.PoolObjectFactory;
import com.barco.framework.TouchHandler;
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < MAX_TOUCHPOINTS; i++) {
                ...
                if (event.getAction() != MotionEvent.ACTION_MOVE && i != pointerIndex) {
                    //if it's an up/down/cancel/out event, mask id to see if we should process it for this touch point
                    continue;
                }
                switch (action) {
